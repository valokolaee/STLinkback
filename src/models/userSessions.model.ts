...
export default class userSessions extends Model {
  public id!: number;
  ...
  public static initModel(sequelize: any): typeof userSessions {
  ...
  public static associate(models: any) {
    userSessions.belongsTo(models.Role, {
      foreignKey: 'roleId',
      as: 'role',
    });

    userSessions.belongsTo(models.Rank, {
      foreignKey: 'rankId',
      as: 'rank',
    });

    userSessions.hasMany(models.ReferralRelationship, {
      foreignKey: 'referrer',
      as: 'referredUsers',
    });

    userSessions.hasMany(models.Pool, {
      foreignKey: 'userId',
      as: 'pools',
    });

    userSessions.hasMany(models.Bank, {
      foreignKey: 'userId',
      as: 'banks',
    });

    userSessions.belongsToMany(models.Permission, {
